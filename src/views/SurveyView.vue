    ...
    <div v-else-if="done" class="w-full max-w-md text-center space-y-6 animate-in fade-in duration-500">
      ...
      <div class="bg-[#1a0f2e] border border-violet-700/40 rounded-[25px] p-7 shadow-[0_0_30px_rgba(139,92,246,0.2)]">
        ...
        <div class="flex items-center justify-center gap-3">
          <span class="text-4xl font-black text-violet-400 tracking-tighter">+{{ REWARD.toLocaleString('vi-VN') }}</span>
    ...
    <div v-else class="w-full max-w-lg space-y-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-violet-400 text-[10px] tracking-widest normal-case font-bold not-italic mt-0.5">Trả lời để nhận {{ REWARD.toLocaleString('vi-VN') }} xu</p>
        </div>
      </div>
